...
export const data = [
    {
        ...
        notes: [
            ...
            { startLine: 20, endLine: 20, type: "explanation", text: "Ораза ұстағаны деген мағынада" },
            {
                startLine: 21,
                endLine: 21,
                type: "explanaition",
                text: "Құрандағы оқудың маңыздылығын айтқым келген(96:1–5, 39:9, 20:114, 58:11)",
            },
            {
                startLine: 25,
                endLine: 25,
                type: "explanaition",
                text: "Адамзаттың құлшылық ету үшін жаратылғаны туралы айтым келген (51:56)",
            },
            {
                startLine: 27,
                endLine: 31,
                type: "explanation box",
                text: "Тақырып біреудің басқаға ренжуі туралы ауысады, осы тақырыпқа да тағы жазатын шығармын",
            },
        ],
    },
    {
        ...
        notes: [
            {
                ...
                endLine: 8,
                type: "citation",
                text: "«Жаратушыға құл болмаған – жаратылғанға құл болады.» (Ибн Таймия, «Әл-Убудийя»).",
            },
        ],
    },
    {
        ...
        notes: [
            {
                ...
                startLine: 0,
                endLine: 6,
                text: "unfinished draft \n \n Ибн Аббас (р.а.) оны бір ғимараттың іргетесіне ұқсатып: «Әр нәрсенің табан тірейтін бір іргетасы, әрі сол іргетастың үстінде бой көтеретін ғимараты болады. Исламның ғимараты – көркем мінез» .(Ғазали, Ихия улумид-дин 3/53; Ибнул Жаузи, Сифатус-сафуа 2/104; Ибн Кәсир, әл-Бидая уән-Ниһая 3/95.)",
            },
        ],
    },
    {
        ...
        preview: { startLine: 0, endLine: 3, ending: "..." },
        notes: [
            { type: "explanation", startLine: 6, endLine: 7, text: "Көз емес, жүрек соқыр болады." },
            {
                type: "explanation",
                startLine: 12,
                endLine: 12,
                text: "Жеңілдік - саған жеңіл болады ма әлде ауыр болады ма келесі өмірде \n \nЖеңілдік - шахид болған адамдарға берілетін жеңілдік сенде болады ма?",
            },
            {
                type: "explanation",
                startLine: 21,
                endLine: 24,
                text: "Рақмет айту - шүкір | зікір, қазу терең - пікір,",
            },
            { type: "explanation", startLine: 32, endLine: 32, text: "Намаз бен пенденің диалогы" },
        ],
    },
];
