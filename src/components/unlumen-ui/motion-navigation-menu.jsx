...
import { Highlight, HighlightItem } from "@/src/components/unlumen-ui/primitives/effects/highlight";
...
function MotionNavigationMenu({
    ...
    const spring = React.useMemo(
        () => ({ type: "spring", bounce: springBounce, stiffness: springStiffness, damping: springDamping }),
    ...
    const updateViewportPosition = React.useCallback(() => {
        ...
        frameRef.current = requestAnimationFrame(() => {
            ...
            const activeTrigger = root.querySelector('[data-slot="navigation-menu-trigger"][data-state="open"]');
...
function MotionNavigationMenuLink({ className, asChild = false, children, ...props }) {
    return (
        <HighlightItem asChild>
            {asChild ? (
                children
